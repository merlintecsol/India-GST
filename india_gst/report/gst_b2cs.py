                ...
                for row in set(map(tuple, ls)):
                    ...
                    if r == 0:
                        ...
                        if obj.partner_id.e_commerce == True:
                            pot.append(['E',obj.partner_id.state_id.state_code + "-" + obj.partner_id.state_id.name,row[1],r,obj.partner_id.e_commerce_tin])
                            check.append(['E',str(obj.partner_id.state_id.state_code + "-" + obj.partner_id.state_id.name),row[1]])
                        else:
                            pot.append(['OE',obj.partner_id.state_id.state_code + "-" + obj.partner_id.state_id.name,row[1],r])
                            check.append(['OE',str(obj.partner_id.state_id.state_code + "-" + obj.partner_id.state_id.name),row[1]])
